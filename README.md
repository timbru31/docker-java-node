# Java (JRE or JDK version 8, 11 or 17) with Node.js 14, 16 LTS or 18 Dockerfile
...
A minimal Dockerfile based on Eclipse Temurin's OpenJDK JRE or JDK 8/11 Dockerfile (regular, alpine) with Node.js 14 LTS (Fermium), 16 LTS (Gallium) or 18 (Hydrogen) installed.
